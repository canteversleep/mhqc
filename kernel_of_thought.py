    ...
    def _generate_instruction(self, mode):
        ...
        if mode == "generate":
            instr = [
                ...
                f"The variable names should be descriptive enough to allow someone to understand what they represent without additional context.",
            ...
            instr = [
                ...
                "Your task is to correct the error and provide the new {mode_outputs}.",
            ]
        return "\n".join(instr)
